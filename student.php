...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" style="background-color: rgb(19 78 74) ; color: white;">
                        <h4>Daftar Pembayaran Mahasiswa

                            <button type="button" style="border-radius: 20px" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#studentAddModal">
                                Tambah Pembayaran
                            </button>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="myTable"  class="table table-bordered table-striped">
                            <thead style="background-color: rgb(19 78 74) ; color: white;">
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                                    <th>NPM</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $student['tgl'] ?></td>
                                            <td>
                                                <button type="button" value="<?= $student['id']; ?>" class="viewStudentBtn btn btn-warning btn-sm" style="border-radius: 20px">View</button>
                                                <button type="button" value="<?= $student['id']; ?>" class="editStudentBtn btn btn-success btn-sm" style="border-radius: 20px">Edit</button>
                                                <button type="button" value="<?= $student['id']; ?>" class="deleteStudentBtn btn btn-danger btn-sm" style="border-radius: 20px">Delete</button>
                                            </td>
                                        </tr>
                                <?php
                                    }
